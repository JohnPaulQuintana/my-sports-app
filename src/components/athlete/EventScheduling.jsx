...
const EventCalendar = ({ assigned }) => {
  ...
  const handleEventClick = (clickInfo) => {
    ...
    Swal.fire({
      ...
      <div class="w-full">
        <div>
          <select disabled id="sportSelect" class="w-full p-2 border border-gray-500">
        ...
        <div class="flex flex-col items-start mb-2">
          <label for="title">Event Title:</label>
          <input readonly type="text" id="title" class="w-full p-2 border border-gray-500" placeholder="Event title" value="${
            event.title
          }" required>
        </div>
        <div class="flex justify-between gap-4 mb-2">
          <div class="flex flex-col items-start w-full">
            <label for="startTime">Start Time:</label>
            <input readonly type="time" id="startTime" class="border p-2 border-gray-500 w-full" value="${event.start
              .toISOString()
              .slice(11, 16)}" required>
          </div>
          <div class="flex flex-col items-start w-full">
            <label for="endTime">End Time:</label>
            <input readonly type="time" id="endTime" class="border p-2 border-gray-500 w-full" value="${event.end
              .toISOString()
              .slice(11, 16)}" required>
          </div>
        </div>
        <div class="flex flex-col items-start w-full">
          <label for="description">Description:</label>
          <textarea readonly id="description" class="border p-2 border-gray-500 w-full" placeholder="Event description">${
